...
public class KPI {
    ...
    public static void main(String args[]) {
        String line = "123.151.77.71 - - [12/May/2020:14:13:47 +0800] \"POST /index/indexui/report.html HTTP/1.1\" 200 827 \"http://2020data.mysspku.com/index/indexui/index\" \"Mozilla/5.0 (Linux; Android 10; MI 9 Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/66.0.3359.126 MQQBrowser/6.2 TBS/045131 Mobile Safari/537.36 MMWEBID/7834 MicroMessenger/7.0.14.1660(0x27000E37) Process/tools NetType/WIFI Language/zh_CN ABI/arm64 WeChat/arm64\"";
        System.out.println(line);
        KPI kpi = new KPI();
        String[] arr = line.split(" ");
