package com.ebways.mq.utils;

import com.alibaba.fastjson.JSON;
import com.ebways.common.utils.StringUtils;
...
/**
 * Created by gmq on 2016/10/09 0009.
 */
public class TaoBaoIpAddressUtils {
    ...
    public static void main(String[] args) {
        TaoBaoIpAddressUtils addressUtils = new TaoBaoIpAddressUtils();
        // 测试ip 58.209.121.6 中国-华东-江苏省-苏州市-电信
        String ip = "58.209.121.6";
        String address = "";
        try {
